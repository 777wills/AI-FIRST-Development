---
description: Genera un `tasks.md` accionable y ordenado por dependencias a partir de los artefactos de diseño disponibles.
handoffs:
  - label: Analizar consistencia
    agent: speckit.analyze
    prompt: Ejecuta un análisis de consistencia del proyecto
    send: true
  - label: Implementar proyecto
    agent: speckit.implement
    prompt: Inicia la implementación por fases
    send: true
scripts:
...
Ejecuta `{SCRIPT}` desde la raíz del repositorio y procesa:

...
description: Crear o actualizar la constitución del proyecto a partir de principios
  proporcionados o definidos interactivamente, garantizando que todas las plantillas
  y artefactos dependientes permanezcan sincronizados.

---
name: speckit-plan
description: Ejecuta el flujo de planificación de implementación para definir la arquitectura,
  el stack tecnológico y los artefactos de diseño.
...
Ejecuta `.specify/scripts/powershell/setup-plan.ps1 -Json` desde la raíz del repositorio y procesa el JSON resultante para obtener:
